        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                <a href="{{route('front.home')}}" class="nav-item nav-link{{(request()->is('/'))?'active' : ''}}">Home</a>
                 <a href="{{route('front.about')}}about.html" class="nav-item nav-link{{(request()->is('/'))?'active' : ''}}">About</a>
                 <a href="{{route('front.services')}}" class="nav-item nav-link{{(request()->is('/'))?'active' : ''}}">Services</a>
                 <a href="{{route('front.packages')}}" class="nav-item nav-link{{(request()->is('/'))?'active' : ''}}">Packages</a>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="{{route('front.desination') }}" class="dropdown-item {{(request()->is('desination')) ? 'active' : '' }}">Destination</a>
                         ...
                         <a href="{{route('front.testimonial')}}" class="dropdown-item{{(request()->is('guide')) ? 'active' : ''}}">Testimonial</a> --}}
